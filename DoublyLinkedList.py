...
class DoublyLinkedList:
    ...
    def append(self, data):
        ...
        if self.tail is None:
            ...
            self.tail = new_node
            return
        self.tail.next = new_node   #add new node to last
        new_node.prev = self.tail #add prev node to current tail
        self.tail = new_node    #set last node to tail
